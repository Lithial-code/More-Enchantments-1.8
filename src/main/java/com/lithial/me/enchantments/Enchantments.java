...
public class Enchantments {
    ...
    public static Enchantment highjump, swiftness, cloud, regen, horticulture,
            ...
            photo, heat, venom, homing,sharpShooter,parry,multipurpose, greenwood,disarm,sunder;
     ...
     //   Property Homing = get(ENCHANT, "Homing", 300);
      ...
      //  Property SharpShooter = get(ENCHANT, "SharpShooter", 331);
       ...
       // allowSharpShooter = getb(ALLOW, "SharpShoooter",true);
        ...
        verticallitybonus = config.get(BONUS, "Verticallity Modifier default = 1.5", 1.5,"dont go to high you'll break it" ).getDouble();
        ...
        flowerUpdate = getInt(UPDATE,"Flower & Netherwart & SugarCane & Crops Timer",5);
      ...
      //  Property CloudMax = get(MAX, "Cloud dont change", 1);
       ...
       // Property SharpShooterMax = get(MAX, "SharpShooter dont change", 1);
        ...
        Property MultiPurposeMax = get(MAX, "MutliPurpose", 3);
	...
	/*	if(allowPenetrate)
		...
		*/
        ...
        if (allowHighJump)
            highjump = new EnchantmentCore(HighJump.getInt(), HighJumpWeight.getInt(), EnumEnchantmentType.ARMOR_FEET, new ResourceLocation("highjump"), 1, HighJumpMax.getInt(), ban(Compat.highjump1), ban(Compat.highjump2), ban(Compat.highjump3), ban(Compat.highjump4));
        if (allowSwiftness)
            swiftness = new EnchantmentCore(Swiftness.getInt(), SwiftnessWeight.getInt(), EnumEnchantmentType.ARMOR_FEET, new ResourceLocation("swiftness"), 1, SwiftnessMax.getInt(), ban(Compat.swiftness1), ban(Compat.swiftness2), ban(Compat.swiftness3), ban(Compat.swiftness4));
        if (allowCloud)
            cloud = new EnchantmentCore(Cloud.getInt(), CloudWeight.getInt(), EnumEnchantmentType.ARMOR_LEGS, new ResourceLocation("cloud"), 1, 1, ban(Compat.cloud1), ban(Compat.cloud2), ban(Compat.cloud3), ban(Compat.cloud4));
        if (allowRegeneration)
            regen = new EnchantmentCore(Regeneration.getInt(), RegenerationWeight.getInt(), EnumEnchantmentType.ARMOR_TORSO, new ResourceLocation("regen"), 1, 1, ban(Compat.regen1), ban(Compat.regen2), ban(Compat.regen3), ban(Compat.regen4));
        	if (allowHorticulture)
           horticulture = new EnchantmentCore(Horticulture.getInt(), HorticultureWeight.getInt(), EnumEnchantmentType.ARMOR_HEAD, new ResourceLocation("horticulture"), 1, 1, ban(Compat.horticulture1), ban(Compat.horticulture2), ban(Compat.horticulture3), ban(Compat.horticulture4));
        if (allowSlowArrow)
            slowArrow = new EnchantmentCore(SlowArrow.getInt(), SlowArrowWeight.getInt(), EnumEnchantmentType.BOW, new ResourceLocation("slowarrow"), 1, SlowArrowMax.getInt(), ban(Compat.slowArrow1), ban(Compat.slowArrow2), ban(Compat.slowArrow3), ban(Compat.slowArrow4));
        if (allowPoisonArrow)
            poisonArrow = new EnchantmentCore(PoisonArrow.getInt(), PoisonArrowWeight.getInt(), EnumEnchantmentType.BOW, new ResourceLocation("poisonarrow"), 1, PoisonArrowMax.getInt(), ban(Compat.poisonArrow1), ban(Compat.poisonArrow2), ban(Compat.poisonArrow3), ban(Compat.poisonArrow4));
        if (allowWitherArrow)
            witherArrow = new EnchantmentCore(WitherArrow.getInt(), WitherArrowWeight.getInt(), EnumEnchantmentType.BOW, new ResourceLocation("witherarrow"), 1, WitherArrowMax.getInt(), ban(Compat.witherArrow1), ban(Compat.witherArrow2), ban(Compat.witherArrow3), ban(Compat.witherArrow4));
        if (allowLethargy)
            slowAspect = new EnchantmentCore(Lethargy.getInt(), LethargyWeight.getInt(), EnumEnchantmentType.WEAPON, new ResourceLocation("slowaspect"), 1, 2, ban(Compat.slowAspect1), ban(Compat.slowAspect2), ban(Compat.slowAspect3), ban(Compat.slowAspect4));
        if (allowPoisonAspect)
            poisonAspect = new EnchantmentCore(PoisonAspect.getInt(), PoisonAspectWeight.getInt(), EnumEnchantmentType.WEAPON, new ResourceLocation("poisonaspect"), 1, PoisonAspectMax.getInt(), ban(Compat.poisonAspect1), ban(Compat.poisonAspect2), ban(Compat.poisonAspect3), ban(Compat.poisonAspect4));
        if (allowWitherAspect)
            witherAspect = new EnchantmentCore(WitherAspect.getInt(), WitherAspectWeight.getInt(), EnumEnchantmentType.WEAPON, new ResourceLocation("witheraspect"), 1, WitherAspectMax.getInt(), ban(Compat.witherAspect1), ban(Compat.witherAspect2), ban(Compat.witherAspect3), ban(Compat.witherAspect4));
        if (allowSlowAoe)
            slowAoe = new EnchantmentCore(SlowAoe.getInt(), SlowAoeWeight.getInt(), EnumEnchantmentType.BOW, new ResourceLocation("slowaoe"), 1, SlowAoeMax.getInt(), ban(Compat.slowAoe1), ban(Compat.slowAoe2), ban(Compat.slowAoe3), ban(Compat.slowAoe4));
        if (allowPoisonAoe)
            poisonAoe = new EnchantmentCore(PoisonAoe.getInt(), PoisonAoeWeight.getInt(), EnumEnchantmentType.BOW, new ResourceLocation("poisonaoe"), 1, PoisonAoeMax.getInt(), ban(Compat.poisonAoe1), ban(Compat.poisonAoe2), ban(Compat.poisonAoe3), ban(Compat.poisonAoe4));
        if (allowWitherAOE)
            witherAoe = new EnchantmentCore(WitherArrowAoe.getInt(), WitherAoeWeight.getInt(), EnumEnchantmentType.BOW, new ResourceLocation("witheraoe"), 1, WitherArrowAoeMax.getInt(), ban(Compat.witherAoe1), ban(Compat.witherAoe2), ban(Compat.witherAoe3), ban(Compat.witherAoe4));
        if (allowVertically)
            verticallity = new EnchantmentCore(Vertically.getInt(), VerticallyWeight.getInt(), EnumEnchantmentType.WEAPON, new ResourceLocation("verticallity"), 1, VerticallyMax.getInt(), ban(Compat.verticallity1), ban(Compat.verticallity2), ban(Compat.verticallity3), ban(Compat.verticallity4));
        if (allowBlast)
            blast = new EnchantmentCore(Blast.getInt(), BlastWeight.getInt(), EnumEnchantmentType.BOW, new ResourceLocation("blast"), 1, BlastMax.getInt(), ban(Compat.blast1), ban(Compat.blast2), ban(Compat.blast3), ban(Compat.blast4));
        if (allowLeech)
            leech = new EnchantmentCore(Leech.getInt(), LeechWeight.getInt(), EnumEnchantmentType.WEAPON, new ResourceLocation("leech"), 1, LeechMax.getInt(), ban(Compat.leech1), ban(Compat.leech2), ban(Compat.leech3), ban(Compat.leech4));
        if (allowWisdom)
            wisdom = new EnchantmentCore(Wisdom.getInt(), WisdomWeight.getInt(), EnumEnchantmentType.WEAPON, new ResourceLocation("wisdom"), 1, WisdomMax.getInt(), ban(Compat.wisdom1), ban(Compat.wisdom2), ban(Compat.wisdom3), ban(Compat.wisdom4));
        if (allowMagnet)
            magnet = new EnchantmentCore(Magnet.getInt(), MagnetWeight.getInt(), EnumEnchantmentType.ARMOR_TORSO, new ResourceLocation("magnet"), 1, MagnetMax.getInt(), ban(Compat.magnet1), ban(Compat.magnet2), ban(Compat.magnet3), ban(Compat.magnet4));
        if (allowVigour)
            vigor = new EnchantmentCore(Vigour.getInt(), VigourWeight.getInt(), EnumEnchantmentType.DIGGER, new ResourceLocation("vigor"), 1, VigourMax.getInt(), ban(Compat.vigor1), ban(Compat.vigor2), ban(Compat.vigor3), ban(Compat.vigor4));
        if (allowNightvision)
            nightvision = new EnchantmentCore(Nightvision.getInt(), NightvisionWeight.getInt(), EnumEnchantmentType.ARMOR_HEAD, new ResourceLocation("nightvision"), 1, 1, ban(Compat.nightvision1), ban(Compat.nightvision2), ban(Compat.nightvision3), ban(Compat.nightvision4));
        if (allowSteadFast)
            steadfast = new EnchantmentCore(SteadFast.getInt(), SteadFastWeight.getInt(), EnumEnchantmentType.ARMOR_LEGS, new ResourceLocation("steadfast"), 1, 1, ban(Compat.steadfast1), ban(Compat.steadfast2), ban(Compat.steadfast3), ban(Compat.steadfast4));
        if (allowQuickDraw)
            quickdraw = new EnchantmentCore(QuickDraw.getInt(), QuickDrawWeight.getInt(), EnumEnchantmentType.BOW, new ResourceLocation("quickdraw"), 1, QuickDrawMax.getInt(), ban(Compat.quickdraw1), ban(Compat.quickdraw2), ban(Compat.quickdraw3), ban(Compat.quickdraw4));
        if (allowIceStep)
            icestep = new EnchantmentCore(IceStep.getInt(), IceStepWeight.getInt(), EnumEnchantmentType.ARMOR_FEET, new ResourceLocation("icestep"), 1, 1, ban(Compat.icestep1), ban(Compat.icestep2), ban(Compat.icestep3), ban(Compat.icestep4));
        if (allowPhoto)
            photo = new EnchantmentCore(PhotoSynthesis.getInt(), PhotoSynthesisWeight.getInt(), EnumEnchantmentType.ARMOR_HEAD, new ResourceLocation("photosynthesis"), 1, PhotoSynthesisMax.getInt(), ban(Compat.photo1), ban(Compat.photo2), ban(Compat.photo3), ban(Compat.photo4));
        if (allowHeat)
         //   heat = new EnchantmentCore(Heat.getInt(), HeatWeight.getInt(), EnumEnchantmentType.DIGGER, new ResourceLocation("heat"), 1, HeatMax.getInt(), ban(Compat.heat1), ban(Compat.heat2), ban(Compat.heat3), ban(Compat.heat4));
        if (allowAntiVenom)
            venom = new EnchantmentCore(AntiVenom.getInt(), AntiVenomWeight.getInt(), EnumEnchantmentType.ARMOR, new ResourceLocation("antivenom"), 1, AntiVenomMax.getInt(), ban(Compat.venom1), ban(Compat.venom2), ban(Compat.venom3), ban(Compat.venom4));
		 ...
		 */
     //   if (allowHoming)
   //         homing = new EnchantmentCore(Homing.getInt(), Homing.getInt(), EnumEnchantmentType.BOW, new ResourceLocation("homing"), 1, HomingMax.getInt(), ban(Compat.homing1), ban(Compat.homing2), ban(Compat.homing3), ban(Compat.homing4));
      //  if (allowSharpShooter)
      //      sharpShooter = new EnchantmentCore(SharpShooter.getInt(), SharpShooterWeight.getInt(), EnumEnchantmentType.BOW, new ResourceLocation("sharpshooter"), 1, SharpShooterMax.getInt(), ban(Compat.sharpshooter1), ban(Compat.sharpshooter2), ban(Compat.sharpshooter3), ban(Compat.sharpshooter4));
        //parry = new EnchantmentCore(Parry.getInt(),ParryWeight.getInt(),EnumEnchantmentType.WEAPON, "parry",1,1,null,null,null,null);
        if(allowMulti)
            multipurpose = new EnchantmentCore(MultiPurpose.getInt(), MultiPurposeWeight.getInt(), EnumEnchantmentType.DIGGER, new ResourceLocation("multipurpose"),1,MultiPurposeMax.getInt(),null,null,null,null);
        if(allowGreenWood)
            greenwood = new EnchantmentCore(GreenWood.getInt(), GreenWoodWeight.getInt(), EnumEnchantmentType.ALL, new ResourceLocation("greenwood"),1,1,null,null,null,null);
        if(allowDisarm)
        disarm = new EnchantmentCore(Disarm.getInt(), DisarmWeight.getInt(), EnumEnchantmentType.WEAPON, new ResourceLocation("disarm"),1,1,null,null,null,null);
        sunder = new EnchantmentCore(335, 5, EnumEnchantmentType.ARMOR_TORSO, new ResourceLocation("sunder"),1,3,null,null,null,null);
    ...
    public static Enchantment ban(int i) {
        return IdExtension.enchantmentsList[i];
    }
