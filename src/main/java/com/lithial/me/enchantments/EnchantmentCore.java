...
public class EnchantmentCore extends Enchantment {
    ...
    protected EnchantmentCore(int id, int weight,EnumEnchantmentType type, ResourceLocation unlocalizedName, int minLevel, int maxLevel, Enchantment par1, Enchantment par2,Enchantment par3, Enchantment par4) {
